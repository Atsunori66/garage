...
def main():
    ...
    message_over1 = end_font.render('You lose...', True, (255, 0, 255))
    message_pos1 = message_over1.get_rect()
    message_pos1.centerx = int(WIDTH / 2)
    message_pos1.centery = int(HEIGHT / 2)

    message_over2 = end_font.render('You win!', True, (0, 255, 255))
    ...
    while True:
        ...
        life1_show = life_font.render('You: ' + str(life1), True, (255, 255, 255))
        life1_pos = life1_show.get_rect()
        life1_pos.centerx = 240
        life1_pos.centery = 40

        life2_show = life_font.render('COM: ' + str(life2), True, (255, 255, 255))
        ...
        if racket1.colliderect(ball):
            direction = -(racket1.centery - ball.centery) - randint(0, 20)
            speed += 0.1
        if racket2.colliderect(ball):
            direction = 180 + (racket2.centery - ball.centery) + randint(0, 20)
            speed += 0.1
